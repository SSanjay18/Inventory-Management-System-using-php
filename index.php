	  ...
	  <div class="row">
		...
		<h1 class="my-4"></h1>
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  ...
			  <a class="nav-link" id="v-pills-tags-tab" data-toggle="pill" href="#v-pills-tags" role="tab" aria-controls="v-pills-tags" aria-selected="false">RFID data</a>
			  <a class="nav-link" id="v-pills-pre-tab" data-toggle="pill" href="#v-pills-pre" role="tab" aria-controls="v-pills-pre" aria-selected="false">PRE order</a>
